	...
	<div id="container">
		<div id="left">
			<table border="1">
				...
				<tbody>
					<c:forEach items="${visitasConHeroe}" var="visitaConHeroe">
						<tr>
							<td>${visitaConHeroe.id}</td>
							<td>${visitaConHeroe.descripcion}</td>
							<td>${visitaConHeroe.fecha}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div id="right">
			<table border="1">
				...
				<tbody>
					<c:forEach items="${heroeDeVisitas}" var="heroeDeVisita">
						<tr>
							<td>${heroeDeVisita.id}</td>
							<td>${heroeDeVisita.nombre}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
