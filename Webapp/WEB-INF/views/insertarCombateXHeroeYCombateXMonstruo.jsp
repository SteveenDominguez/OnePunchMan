...
<body>
	...
	<form action="guardarCombateXHeroeYCombateXMonstruo" method="post">
		...
		<div class="form-group">
			<label for="exampleInputText1">Monstruo</label> <select
				name="monstruo">
				<c:forEach items="${monstruos}" var="monstruo">
					<option value="${monstruo.id }">${monstruo.nombre}</option>
				</c:forEach>
			</select>
		</div>
